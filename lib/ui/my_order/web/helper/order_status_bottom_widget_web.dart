...
class OrderStatusBottomWidgetWeb extends StatelessWidget with BaseStatelessWidget {
  const OrderStatusBottomWidgetWeb({super.key});
  ...
  Widget buildPage(BuildContext context) {
    return Consumer(builder: (context, ref, child) {
      ...
      return Visibility(
        visible: false,
        //visible:  homeWatch.getIsShowingOrderStatusWidget(),
