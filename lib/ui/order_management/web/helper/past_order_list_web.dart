...
import 'package:kody_operator/ui/order_management/web/helper/past_order_card_web.dart';
...
class PastOrderList extends ConsumerStatefulWidget {
  const PastOrderList({Key? key}) : super(key: key);

  @override
  ConsumerState<PastOrderList> createState() => _PastOrderListState();
}

class _PastOrderListState extends ConsumerState<PastOrderList> with BaseConsumerStatefulWidget {
  ///Init Override
  @override
  void initState() {
    super.initState();
          ...
          return Column(
            ...
            children: [
              Row(
                ...
                children: [
                  CommonText(
                    title: LocalizationStrings.keyPreparedOrder.localized,
                    textStyle: TextStyles.regular.copyWith(fontSize: 18.sp, color: AppColors.grey636363),
                  ),
                  CommonText(
                    title: '${orderStatusWatch.pastSocketOrders.length} ${LocalizationStrings.keyOrders.localized}',
              ...
              //const UserCard(),
              Expanded(
                child: orderStatusWatch.pastSocketOrders.isEmpty
