...
class OtpVerificationFormProfile extends ConsumerWidget with BaseConsumerWidget {
  final String email;
  final FromScreen fromScreen;
  const OtpVerificationFormProfile({super.key, required this.email,required this.fromScreen});
  ...
  Widget buildPage(BuildContext context, ref) {
    ...
    return Column(
      ...
      children: [
        ...
        CommonText(
          title:fromScreen==FromScreen.changeMobile? '${LocalizationStrings.keyWeHaveSentYouAnOtp.localized} ${LocalizationStrings.keyMobileNumber.localized} ':
          '${LocalizationStrings.keyWeHaveSentYouAnOtp.localized} ${LocalizationStrings.keyEmailId.localized} ',          textStyle: TextStyles.regular.copyWith(fontSize: 16.sp, color: AppColors.black),
        ),
        CommonText(
          title: email,
        ...
        RichText(
          text: TextSpan(text: fromScreen==FromScreen.changeMobile?LocalizationStrings.keyNotYourMobileNo.localized: LocalizationStrings.keyNotYourEmail.localized, style: TextStyles.regular.copyWith(fontSize: 16.sp, color: AppColors.black), children: [
            TextSpan(
