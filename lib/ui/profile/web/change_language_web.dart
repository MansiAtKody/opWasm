...
import 'package:kody_operator/ui/profile/web/shimmer/shimmer_change_language_web.dart';
...
class ChangeLanguageWeb extends ConsumerWidget with BaseConsumerWidget {
  const ChangeLanguageWeb({super.key});

  @override
  Widget buildPage(BuildContext context, WidgetRef ref) {
    final languageWatch = ref.watch(languageController);
    return languageWatch.isLoading ? const ShimmerChangeLanguageWeb() : FadeBoxTransition(
      child: Container(
