...
class RobotTrayTopWidgetMobile extends ConsumerStatefulWidget  {
  const RobotTrayTopWidgetMobile({super.key});

  @override
  ConsumerState<RobotTrayTopWidgetMobile> createState() => _RobotTrayTopWidgetMobileState();
}

class _RobotTrayTopWidgetMobileState extends ConsumerState<RobotTrayTopWidgetMobile> with BaseConsumerStatefulWidget{
                    ...
                    if(index != robotTraySelectionWatch.robotList.length) {
                      ...
                      return Column(
                        children: [
                          ...
                          ListBounceAnimation(
                            onTap: () {
                              if (robotTrayStatusValues.map[robotModel
                                  .state] == RobotTrayStatusEnum.AVAILABLE) {
