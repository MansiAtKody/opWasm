...
class CommonLocationDialogue extends StatelessWidget with BaseStatelessWidget {
  final void Function()? onLocationSelected;
  final void Function()? onContinueButtonPressed;

  const CommonLocationDialogue({super.key, this.onLocationSelected, this.onContinueButtonPressed});
    ...
    return SizedBox(
      ...
      child: Consumer(
        builder: (BuildContext context, WidgetRef ref, Widget? child) {
          ...
          return InkWell(
            onTap: () {
              announcementWatch.updateSelectedTempLocation(index);
              announcementWatch.updateSelectedDepartment(selectedDepartment: locationModel);
            },
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    height: 30.h,
                    child: Icon(
                      announcementWatch.selectedLocationTempIndex == index ? Icons.radio_button_checked : Icons.radio_button_off,
                      color: announcementWatch.selectedLocationTempIndex == index ? AppColors.primary2 : AppColors.clr171717,
                    ),
                  )
                ],
              ),
