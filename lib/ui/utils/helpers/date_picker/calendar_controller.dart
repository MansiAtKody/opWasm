...
class CalendarController extends ChangeNotifier {
  ...
  isMonthAvailable(index) {
    ...
    if (firstDate == DateTime(1900) && lastDate == DateTime(DateTime.now().year + 50)) {
      ...
      return (dateTime.year == firstDate.year && dateTime.month >= firstDate.month);
    } else if (firstDate == DateTime(1900) && lastDate != DateTime(DateTime.now().year + 50)) {
      return (dateTime.year == lastDate.year && dateTime.month <= lastDate.month);
    } else if (firstDate != DateTime(1900) && lastDate != DateTime(DateTime.now().year + 50)) {
      return ((dateTime.year == firstDate.year && dateTime.month >= firstDate.month) && (dateTime.year == lastDate.year && dateTime.month <= lastDate.month));
    }
    return true;
  }
