...
class CommonButtonCoffeeSelection extends StatefulWidget {
  final double? height;
  final double? width;
  ...
  const CommonButtonCoffeeSelection({
    Key? key,
    this.height,
    this.width,
  ...
  @override
  State<CommonButtonCoffeeSelection> createState() => _CommonButtonState();
}

class _CommonButtonState extends State<CommonButtonCoffeeSelection> {
  @override
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              ...
                              style:
                                  widget.buttonTextStyle ?? TextStyles.regular.copyWith(fontSize: widget.buttonTextSize ?? 22.sp, color: widget.buttonTextColor ?? AppColors.white),
                            ),
