...
class CommonCheckBoxMobile extends StatelessWidget with BaseStatelessWidget{
  const CommonCheckBoxMobile({
    Key? key,
    required this.value,
    ...
    return Checkbox(
      ...
      side: side ?? MaterialStateBorderSide.resolveWith(
          ...
          if (states.contains(MaterialState.selected)) {
            ...
            return BorderSide(color: AppColors.grey929292, width: 1.w);
          }
        },
      ),
      value: value,
